...
def main():
    ...
    while running:
        with sr.Microphone() as source:
            log.append(f"[{Fore.YELLOW}{Style.BRIGHT}...{Fore.WHITE}{Style.NORMAL}] Ajusting noise")
        ...
        try:
            ...
            log.append(f"[{Fore.YELLOW}{Style.BRIGHT}?{Fore.WHITE}{Style.NORMAL}] Didint Made The World")
            printlog()
